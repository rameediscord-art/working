      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            <p>Please read these Terms of Service carefully before using our website or purchasing any of our products. By accessing or using this site, you agree to be bound by these terms.</p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-foreground mb-3">2. Description of Products</h2>
              <p>We offer three digital products, each available as a one-time purchase:</p>
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li><strong className="text-foreground">Discord Access ($14)</strong> — Permanent access to the private Discord server. No expiry, no renewal required.</li>
                <li><strong className="text-foreground">Live 1-on-1 Session ($60)</strong> — One private live session lasting 2 hours, scheduled after purchase via email.</li>
                <li><strong className="text-foreground">Full Bundle ($120)</strong> — Includes Discord Access, one Live 1-on-1 Session, and full access to all resources and materials for 30 days.</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>All prices are displayed on the Pricing page and are in USD</li>
                <li>Every purchase is a single, one-time payment — you will never be charged again for the same product</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                <li><strong className="text-foreground">Discord Access</strong> — Invite link sent within a few hours of payment confirmation</li>
                <li><strong className="text-foreground">Live 1-on-1 Session</strong> — We will email you to schedule the session at a mutually convenient time</li>
                <li><strong className="text-foreground">Full Bundle</strong> — Discord invite and session scheduling email sent within a few hours of confirmation</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                ...
                <li>Resell or redistribute our digital products without written permission</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-3">
                ...
                <li>Our total liability to you for any claim shall not exceed the amount you paid for the product in question</li>
