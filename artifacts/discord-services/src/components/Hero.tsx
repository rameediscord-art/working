  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex items-center min-h-[90vh]">
      ...
      <div className="container px-4 md:px-6 relative z-10 mx-auto text-center">
        ...
        >
          <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-8" data-testid="hero-badge">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-white/60">
            Premium Discord Digital Services & Community Access
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
            Purchase premium digital services, tools, memberships, and community access instantly through our secure Discord-based platform.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8 border-t border-border/50">
            {[
              ...
              <div key={i} className="flex flex-col items-center justify-center" data-testid={`stat-${stat.label.toLowerCase()}`}>
